        ...
        await transporter.sendMail({
            ...
            html: `
                <div style="font-family: Arial, sans-serif; background-color: #161616; padding: 20px;">
                    <div style="max-width: 500px; background-color: #1f1f1f; margin: auto; border-radius: 8px; padding: 20px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border: 1px solid #333;">
                        ...
                        <p style="color: #cbcbcb; font-size: 12px; margin-top: 20px;">
